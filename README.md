...
> In this project, we will restructure the Awesome books app code. The goal is to make it more organized by using modules. We will also practice the ES6 syntax that you we learned.
...
## 💻 Awesome books with ES6<a name="vgs-presentation"></a>
...
```sh
  cd my-folder
  git clone https://github.com/alex1779/awesome-books-with-ES6.git
```
